...
// individual page.
// Format: Text.
const alternatives = `You won't need any other alternative statements because you'll hear this one repeatedly.`;


// This is the short section at the top of the individual page.
// Format: HTML.
const short_answer = `<p>Cheese is defined by three things, fat, salt and cruelty to animals. You can get the first two, fat and salt, from other things while reducing the third, cruelty, at the same time.</p>`;
...
<p>So if you agree that dairy is an industry we neither need nor want, how do we start moving beyond it? Butter and cheese can be replaced by anything with some fat in it, that's what people are really after anyway.  Avocado is a common go to, but depending on what you are eating there are various nut butters, plant oils, tahini and all sorts of the amazingly versatile hummouses. If they don't do it for you there are plant-based versions of most dairy products which are getting more varied all the time, soft cashew cheeses, hard cheeses, cheddar style slices, even blue cheeses. Milk has so many plant-based options it is hard to keep up; Oat, hemp, almond, cashew, soy, rice, coconut and various blends of them are all popular, and they come in many styles such as light, creamy and specialised barista versions. You would have to determined to not find something you like. Soy is probably the most complete nutritionally, but oat milk is generally people’s favourite for drinks. For yoghurt and ice cream, coconut is a good alternative, but here as well there are a vast number of alternatives and you should just try them and figure out which one you prefer.</p>
<p>Positive changes in life can be hard, getting to bed earlier, exercising every day, loving enough, keeping money from corrupting our political systems, etc. Giving up dairy though is pretty easy, so why not take this rare quick win for animals and the environment? It is literally as easy as adding one word like “soy” when you order coffee, or maybe ask them which plant-based milk they recommend. When you shop, just reach for something from a slightly different part of the shelf. A little bit of exploration, a small change in habits, and you will never look back.</p>
<p>Finally if cheese really is that much of a sticking point, maybe put it a little lower on your list of products to change so you don’t let it be a barrier to other positive change. Like breaking other habits, sometimes it helps to minimise first, have a transitory phase, but remember millions of other people have made this positive change, and you can too. Don’t think of it as giving something up, but instead think of it as embracing a kinder world.</p>
`;
