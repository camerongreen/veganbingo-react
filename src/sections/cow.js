...
// Format: HTML.
const short_answer = `<p>It should come as little surprise that intensive animal farming is strictly controlled. Livestock breeding is highly artificial and responds to the laws of supply and demand rather than animal welfare. The fewer animal products people eat, the fewer animals farmers will breed. It may be interesting to think about “what if we just stopped eating animals?” but in reality, it will be a gradual transition giving society time to adjust.</p>`;


// This is the body of the individual page, use HTML liberally.
// Format: HTML.
const long_answer = `
<p>People often say things that reveal how divorced they are from the reality of modern industrial farming. It is far removed from the cow with a daisy in its mouth, or an anthropomorphised pig smiling in the sunshine that the industry promotes through its packaging and advertisements. Using animal bodies for food production is big business run by corporations to maximise profits for their owners and investors. Insemination is highly artificial, bloodlines and genetics are strictly controlled.</p>
...
<p>Of course it’s not a well-thought-through question as it is unlikely that the end of industrial animal farming will happen overnight. People give up things gradually, and ideas often spread slowly among societies. Vegans are still a minority, far from any position enabling us to legislate less cruel farming practices much less abolish unnecessary cruelty to other species. Our dairy and meat-eating, often paradoxically self-proclaimed “animal-loving”, friends needn’t worry. They can give up animal products without the nightmare of empty factory farms and slaughterhouses, of rewilded lands, or of animals free to live life according to their nature and desires. The real nightmare is of course what eating animals on an industrial scale has created in our world now, with the hook, cage, brand, barbed wire, whip, electric prod, slaughterhouse and countless other tools of animal oppression.</p>
